...
function Complaintmodel() {
    return (
        <div className="absolute bg-white z-50 mt-36 ml-96 p-6 shadow-xl rounded-sm">
           <div>
           <form className="w-96 ">
                <h2 className="ml-20 my-6 text-lg">Write Your Complaint</h2>
                <textarea className="w-5/6 h-32 ml-8 border-black border-2"></textarea>
                <div className="flex m-8 justify-center items-center"> 
                <button className="w-24 bg-secondarygreen hover:bg-lightgreen p-2 text-white text-center mr-7 rounded-sm">Send</button>
                <button className="w-24 bg-redcolor p-2 text-white text-center rounded-sm">Close</button>
                </div>
            </form>
           </div>
        </div>
