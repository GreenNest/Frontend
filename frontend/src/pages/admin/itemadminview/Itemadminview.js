...
const ItemAdminView = () => {
    ...
    const listitems = product_card.map((item)=>
      <div className="my-8 mx-12 bg-white border-2 font-semibold shadow-lg grid grid-cols-5 gap-12">
           <div className="m-6"><img className="w-12 h-12  transform hover:scale-150" src={item.thumb} /></div>
            {/* <Link to="/shop/product"> */}
                <div className="m-6 mt-8 text-maingreen hover:text-hovergreen">{item.product_name}</div>
            {/* </Link> */}
        ...
        <div className="w-11/12 h-full -ml-10 -mt-20 justify-end">
            <div className=" flex-row w-3/4  ml-96 pb-5 mt-24 absoulte grid grid-cols-2">
                    ...
                    {/* <div className="flex space-x-4 p-4 mr-12" > */}
                        ...
                        <div className="mr-12 w-72"><Search className=""/></div>
                    {/* </div> */}
            </div> 
            ...
            <div className="w-3/4 bg-gray-500 bg-opacity-25 ml-96 pb-6 -mt-8 rounded">
                ...
                <div className=" h-20 mx-12 grid grid-cols-5 gap-12 text-sm font-semibold -mb-6">
                   <div  className="mt-8 px-4"></div>
                   <div className=" mt-8 px-6">Item Name</div>
