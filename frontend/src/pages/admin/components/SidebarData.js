...
export const SidebarData = [
    ...
    }, 
    {
        ...
        icon: <GrIcons.GrView className="w-5 h-5 mr-3 mt-0.5"/>,
        style: "hover:bg-blue-400 bg-blue-200 hover:text-white flex font-bold p-3 rounded w-48",
    },
    {
        title: 'Add Item',
        path: '/admin/addItem',
        icon: <BiIcons.BiMessageAltAdd className="w-5 h-5 mr-3 mt-0.5"/>,
        style: "hover:bg-blue-400 bg-blue-200 hover:text-white flex font-bold p-3 rounded w-48",
    },
    {
        title: 'Update Stock',
        path: '/admin/updateStock',
        icon: <MdIcons.MdSystemUpdateAlt className="w-5 h-5 mr-3 mt-0.5"/>,
        style: "hover:bg-blue-400 bg-blue-200 hover:text-white flex font-bold p-3 rounded w-48",
    },
    {
        title: 'View Supplier',
    ...
    },
    {
        ...
        icon: <MdIcons.MdPersonAdd className="w-5 h-5 mr-3 mt-0.5"/>,
        style: "hover:bg-red-400 bg-red-200 hover:text-white flex font-bold p-3 rounded w-48",
    },
    {
        title: 'View Employee',
    ...
    },
    {
        ...
        icon: <TiIcons.TiUserAdd className="w-5 h-5 mr-3 mt-0.5"/>,
        style: "hover:bg-gray-400 bg-gray-300 hover:text-white flex font-bold p-3 rounded w-48",
    },
    {
        title: 'Reports',
        path: '/admin/reports',
        icon: <HiIcons.HiDocumentReport className="w-5 h-5 mr-3 mt-0.5"/>,
